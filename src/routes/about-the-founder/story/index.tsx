            ...
            <div class="row no-gutters slider-text align-items-end justify-content-center" style="height: 450px;">
                <div class="col-md-9 mb-5 text-center">
                    <p class="breadcrumbs">
                        ...
                        <span>Story - About The Founder <i class="fa ion-ios-arrow-round-forward"></i></span>
                    </p>
                    <h1 class="mb-0 bread">Story</h1>
                </div>
            </div>
        </div>
    </section>       
...
export const head: DocumentHead = {
  title: 'Story - About The Founder',
  meta: [
    {
      name: 'description',
      content: 'Story - About The Founder',
    },
  ],
};