            ...
            <div class="row no-gutters slider-text align-items-end justify-content-center" style="height: 450px;">
                <div class="col-md-9 mb-5 text-center">
                    <p class="breadcrumbs">
                        ...
                        <span>Facilties <i class="fa ion-ios-arrow-round-forward"></i></span>
                    </p>
                    <h1 class="mb-0 bread">Facilties</h1>
                </div>
            </div>
        </div>
    </section>       
...
export const head: DocumentHead = {
  title: 'Facilities - Sambodhi Retreat Centre',
  meta: [
    {
      name: 'description',
      content: 'Facilities - Sambodhi Retreat Centre',
    },
  ],
};