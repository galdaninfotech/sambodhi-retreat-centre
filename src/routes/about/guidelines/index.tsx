            ...
            <div class="row no-gutters slider-text align-items-end justify-content-center" style="height: 450px;">
                <div class="col-md-9 mb-5 text-center">
                    <p class="breadcrumbs">
                        ...
                        <span>Guidelines <i class="fa ion-ios-arrow-round-forward"></i></span>
                    </p>
                    <h1 class="mb-0 bread">Guidelines</h1>
                </div>
            </div>
        </div>
    </section>       
            ...
            <div class="row">
                <div class="col-lg-6 col-xl-7 order-lg-first py-5 heading-section aos-init aos-animate" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                    <div class="py-md-5 px-lg-5">
                        <span class="subheading">Mahabodhi International Meditation Centre</span>
...
export const head: DocumentHead = {
  title: 'Guidelines - Sambodhi Retreat Centre',
  meta: [
    {
      name: 'description',
      content: 'Guidelines - Sambodhi Retreat Centre',
    },
  ],
};